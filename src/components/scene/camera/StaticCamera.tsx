...
const POSITION_DIR_DESKTOP = new THREE.Vector3(0, 5, 13)
...
function positionFor(aspect: number): THREE.Vector3 {
...
export function StaticCamera() {
  ...
  useEffect(() => {
    ...
    cam.position.copy(positionFor(aspect))
    cam.lookAt(LOOK_AT)
  ...
  // without an exaggerated top-down look.
  useEffect(() => {
