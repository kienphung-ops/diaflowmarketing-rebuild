...
export async function generateMetadata({ params }: Params) {
  ...
  return {
    title: `Floor ${preview.floor} — ${preview.floorLabel} | Diaflow teammate`,
    description: `Preview Floor ${preview.floor} of the Diaflow teammate. Unlock at ${preview.invitesRequired} invites.`,
  }
}
