...
Document as a **Scenario | Behavior** table (see `technical-spec-template.md` Section 5):
...
- Document legacy/backward-compat scenarios
- Cover concurrent access patterns
