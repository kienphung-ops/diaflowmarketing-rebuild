...
### 4. Technical Spec Structure

Load: `references/technical-spec-template.md`
**Use when:** Creating feature specs, system design docs, or architecture docs. Provides the canonical document structure with all required sections.
